...
import 'package:firebase/helper/auth.dart';
import 'package:firebase/helper/sign_in.dart';
import 'package:firebase/widget/first_screen.dart';
import 'package:firebase/widget/second_screen.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Lailatul Mufida / -2031710094"),
      ),
